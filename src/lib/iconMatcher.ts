...
const specialMappings: Record<string, string> = {
  ...
  'new playground for school': '/images/playground.png',
  ...
  'plastic recycling': '/images/ECOBUSSTOP.png',
  ...
  'eco points': '/images/eco_points_7986841.png',
  ...
  'from landfill to playground': '/images/playground.png',
  'mahalla transformation': '/images/Bobur.png',
  'landfill to playground': '/images/playground.png',
